...
# Create a FastAPI instance and router
app = FastAPI()
router = APIRouter()
...
@router.get("/v1/{document}/sections")
...
@router.get("/v1/{document}/metadata")
...
@router.get("/v1/{document}/document_control")
...
@router.get("/v1/{document}/{section}")
